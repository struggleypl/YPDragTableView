...
@interface MSMenuView()<UITableViewDelegate,UITableViewDataSource>
{
    CGPoint          _refPoint;
    UIView          *_refView;
    CGFloat          _menuWidth;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    MSMenuCell *cell = [tableView dequeueReusableCellWithIdentifier:menuCellID forIndexPath:indexPath];
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[MSMenuCell class] forCellReuseIdentifier:menuCellID];
    }
    return _tableView;
}
...
//        [_collectionView registerClass:[MSSliderContainerCell class] forCellWithReuseIdentifier:@"MSSliderContainerCell"];
